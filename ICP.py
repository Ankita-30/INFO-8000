    ...
    def extract_pixels_from_color_image(self, model_or_data):
        ...
        if self.corners_or_edges == "edges":
            ...
            if model_or_data == "model":
                ...
                print("Model pixel list")
                print(edge_pixel_list)
                f=open(r'C:\Users\ar54482\Desktop\WebAPIRH\Project\Data Acquisition\NS\modelcoordinates.txt', 'w') 
                simplejson.dump(edge_pixel_list, f)
                f.close
                ...
                print("Data pixel list")
                print(edge_pixel_list)
                f=open(r'C:\Users\ar54482\Desktop\WebAPIRH\Project\Data Acquisition\NS\datacoordinates.txt', 'w') 
                simplejson.dump(edge_pixel_list, f)
                f.close
    ...
    def icp(self):
        ...
        while 1:
            if iteration == self.iterations: 
                ...
                print("\nFinal rotation and translation of the data image with respect to the model mean change!!!!!!: ")
                print("\nRotation:")
                print(str(self.R)) 
                print("\nTranslation:")
                print(str(self.T))
            ...
            print (R)
            ################################################################################################
            f = open(r'C:\Users\ar54482\Desktop\WebAPIRH\Project\Data Acquisition\NS\Rotationmatrix.txt', 'w')
            print(R, file = f)
            ...
            print("\nTranslation:")
            print(T)
            f = open(r'C:\Users\ar54482\Desktop\WebAPIRH\Project\Data Acquisition\NS\Translationnmatrix.txt', 'w')
            print(T, file = f)
            #################################################################################################
            ...
            print("\nTransformed Data:")
            print(data_transformed_new)
            f=open(r'C:\Users\ar54482\Desktop\WebAPIRH\Project\Data Acquisition\NS\superimposedcoordinates.txt', 'w') 
            simplejson.dump(data_transformed_new, f)
            f.close
